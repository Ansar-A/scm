...
/** @var frontend\models\JenisBarangSearch $searchModel */
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <h4 class="card-title">Table Data Jenis Barang</h4>
                            <p class="card-description"> List Data Jenis Barang Anda.
                            </p>
                        </div>
                        <div class="col-lg-4 text-end"><?= Html::a('<i class="fa fa-plus"></i> Add Jenis', ['create'], ['class' => 'btn btn-success']) ?></div>
                    </div>
