      ...
      <div class="col-lg-8">
        ...
        <div class="">
            <div class="alert-box gray-alert pl-100">
                  <div class="left">
                    <h5 class="text-bold">Kode <?= $model->pemesananAdmin->kode_pemesanan ?></h5>
                  </div>
                  <div class="alert">
                    <h4 class="alert-heading">Kode Barang: <?= $model->pemesananAdmin->dataBarang->kode_barang ?></h4>
                    <p class="text-medium">
                      <?= $model->pemesananAdmin->dataBarang->nama_barang ?>
                    </p>
                  </div>
                </div>

      <!--     <div class="input-style-1">
            <?= $form->field($model, 'pemesanan_admin_id')->dropDownList(
            ArrayHelper::map(PemesananAdmin::find()->all(), 'id', 'kode_pemesanan'),
            [
                'disabled' => true,
                'onchange' => '
                $.post("' . Url::to(['pembayarans/get-kode-pemesanan']) . '&id=" + $(this).val(), function(data) {
        ...
        <div class="input-style-5 pt-20 text-center">
            <a href="<?=Url::to(['pemesanan-admin/index'])?>" class="main-btn light-btn-outline btn-hover">Kembali</a>
...
<div class="col-lg-4">
    <div class="card-style mb-30">
        ...
        <div class="input-style-1">
            <img src="<?= Yii::getAlias('@web') . '/' . $model->pemesananAdmin->dataBarang->foto_barang ?>" 
                 alt="Foto Barang" 
