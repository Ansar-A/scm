...
<?php $this->beginBody() ?>
      ...
      <div class="navbar-logo">
        <a href="index.html">
          <img src="<?=Url::to('@web/plain/assets/images/logo/logo.svg')?>" alt="logo" />
        </a>
      </div>
      <nav class="sidebar-nav">
        <ul>
          ...
          <li class="nav-item">
            <a href="<?= Url::to(['data-barang/index'])?>">
              <span class="icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M3.33334 3.35442C3.33334 2.4223 4.07954 1.66666 5.00001 1.66666H15C15.9205 1.66666 16.6667 2.4223 16.6667 3.35442V16.8565C16.6667 17.5519 15.8827 17.9489 15.3333 17.5317L13.8333 16.3924C13.537 16.1673 13.1297 16.1673 12.8333 16.3924L10.5 18.1646C10.2037 18.3896 9.79634 18.3896 9.50001 18.1646L7.16668 16.3924C6.87038 16.1673 6.46298 16.1673 6.16668 16.3924L4.66668 17.5317C4.11731 17.9489 3.33334 17.5519 3.33334 16.8565V3.35442ZM4.79168 5.04218C4.79168 5.39173 5.0715 5.6751 5.41668 5.6751H10C10.3452 5.6751 10.625 5.39173 10.625 5.04218C10.625 4.69264 10.3452 4.40927 10 4.40927H5.41668C5.0715 4.40927 4.79168 4.69264 4.79168 5.04218ZM5.41668 7.7848C5.0715 7.7848 4.79168 8.06817 4.79168 8.41774C4.79168 8.76724 5.0715 9.05066 5.41668 9.05066H10C10.3452 9.05066 10.625 8.76724 10.625 8.41774C10.625 8.06817 10.3452 7.7848 10 7.7848H5.41668ZM4.79168 11.7932C4.79168 12.1428 5.0715 12.4262 5.41668 12.4262H10C10.3452 12.4262 10.625 12.1428 10.625 11.7932C10.625 11.4437 10.3452 11.1603 10 11.1603H5.41668C5.0715 11.1603 4.79168 11.4437 4.79168 11.7932ZM13.3333 4.40927C12.9882 4.40927 12.7083 4.69264 12.7083 5.04218C12.7083 5.39173 12.9882 5.6751 13.3333 5.6751H14.5833C14.9285 5.6751 15.2083 5.39173 15.2083 5.04218C15.2083 4.69264 14.9285 4.40927 14.5833 4.40927H13.3333ZM12.7083 8.41774C12.7083 8.76724 12.9882 9.05066 13.3333 9.05066H14.5833C14.9285 9.05066 15.2083 8.76724 15.2083 8.41774C15.2083 8.06817 14.9285 7.7848 14.5833 7.7848H13.3333C12.9882 7.7848 12.7083 8.06817 12.7083 8.41774ZM13.3333 11.1603C12.9882 11.1603 12.7083 11.4437 12.7083 11.7932C12.7083 12.1428 12.9882 12.4262 13.3333 12.4262H14.5833C14.9285 12.4262 15.2083 12.1428 15.2083 11.7932C15.2083 11.4437 14.9285 11.1603 14.5833 11.1603H13.3333Z" />
              ...
              <span class="text">Barang Produsen</span>
            </a>
          </li>
          <span class="divider"><hr /></span>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="<?=Url::to(['pemesanan-admin/index'])?>"> Pemesanan </a>
              </li>
              <li>
                <a href="<?=Url::to(['pembayarans/index'])?>"> Pembayaran </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Transaksi Consumen</span>
            </a>
            <ul id="ddmenu_9" class="collapse dropdown-nav">
              <li>
                <a href="<?=Url::to(['pemesanan-konsumen/index'])?>"> Pemesanan From Consumen </a>
              </li>
              <li>
                <a href="<?=Url::to(['pembayaran-konsumen/index'])?>"> Pembayaran From Consumen </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">My Produk </span>
            </a>
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="<?=Url::to(['merek-produk/index'])?>"> Merek </a>
              </li>
              <li>
                <a href="<?=Url::to(['data-produk/index'])?>"> Produk </a>
              </li>
            </ul>
          </li>
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="<?=Url::to('@web/plain/assets/images/logo/logo-icon-big.svg')?>" alt="Logo">
        </div>
        <h3>More Info</h3>
        <p>Supplay Chains Management Sistem</p>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="<?=Url::to('@web/' . Yii::$app->user->identity->photo)?>" alt="">
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="<?=Url::to('@web/' . Yii::$app->user->identity->photo)?>" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm"><?php echo Yii::$app->user->identity->username;?></h4>
                          <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs" >Admin</a>
                        </div>
                      </div>
                    </li>
                    <li class="divider"></li>
                    ...
                    <li>
                      <a href="<?=Url::to(['user/index'])?>"> <i class="lni lni-cog"></i> Settings </a>
                    </li>
                    <li class="divider"></li>
                    <li>
                      <a data-method="POST" href="<?=Url::to(['logout'])?>"> <i class="lni lni-exit"></i> Sign Out </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
